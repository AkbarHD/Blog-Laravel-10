  <!-- categories dpt dari CategoryController -->
  {{-- karna modal itu ada di di index jd tinggal ambil aja categoryControler index tidak perlu bikin di delete --}}
                  ...
                  <div class="modal-body">
                      <form action="{{ url('categories/' . $item->id) }}" method="POST">
                          ...
                          <div class="form-group">
                              <p>Yakin Hapus Data <b> <u> {{ $item->name }}</u></b></p>
                          </div>
